...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Bắt buộc chọn',
        empty           : 'Vui lòng nhập thông tin',
        min             : 'Thông tin nhập vào quá ngắn',
        max             : 'Thông tin nhập vào quá dài',
        number_min      : 'Giá trị nhập vào quá thấp',
        number_max      : 'Giá trị nhập vào quá cao',
        url             : 'URL không hợp lệ',
        number          : 'Đây không phải định dạng số',
        email           : 'Địa chỉ email không hợp lệ',
        email_repeat    : 'Địa chỉ email không trùng khớp',
        password_repeat : 'Mật khẩu không trùng khớp',
        repeat          : 'Không trùng khớp',
        complete        : 'Thông tin chưa hoàn tất',
